...
Conversational workflow to create a well-structured GitLab issue. No arguments — guide the developer from rough idea to polished ticket.
...
```bash
glab label create "<label>" --description "<description>"
```
...
Show the issue URL returned by `glab issue create`.
